  ...
  <div class="container">
    <div class="content">
      <div class="selector">
        ...
        <el-select size="small" v-model="key"
                   filterable
                   clearable
                   placeholder="请选择线路名">
          <el-option
      ...
      <div style="color: red; font-size: 16px; margin: 6px 0;">
        <div style="margin-bottom: 6px;">注意，新建线路周计划之前，请确保线路年计划、月计划已创建并下发.</div>
        <div>注意，每个线路只能有一个周计划，若需新建计划请删除该线路已存在的周计划.</div>
      </div>
      <el-table
          :data="tableData1"
          border
...
const opennewDlg = function (planType = '周计划') {
